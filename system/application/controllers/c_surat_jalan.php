...
class C_surat_jalan extends Controller {

	//constructor
	function C_surat_jalan(){
		parent::Controller();
		session_start();
		$this->load->model('m_surat_jalan', '', TRUE);
	}
	
	//set index
	function index(){
		$this->load->helper('asset');
		$this->load->view('main/v_surat_jalan');
	...
	function print_faktur(){
		...
		$faktur=(isset($_POST['faktur']) ? @$_POST['faktur'] : @$_GET['faktur']);
		$opsi="faktur";
        $result = $this->m_surat_jalan->get_laporan("","","",$opsi,"",$faktur);
		...
		$data['mbank_nama']=$rs->mbank_nama;
		$data['mbank_rekening']=$rs->mbank_rekening;
		$data['mbank_atasnama']=$rs->mbank_atasnama;
		$data['cust_ekspedisi']=$rs->cust_ekspedisi;
		...
		$print_view=$this->load->view("main/p_surat_jalan.php",$data,TRUE);
	...
	function print_laporan(){
		...
		$data["data_print"]=$this->m_surat_jalan->get_laporan($tgl_awal,$tgl_akhir,$periode,$opsi,$group,"");
		if($opsi=='rekap'){
	...
	function get_list_barang_by_faktur_id(){
		$orderid = isset($_POST['orderid']) ? @$_POST['orderid'] : "";
		$result=$this->m_surat_jalan->get_list_barang_by_faktur_id($orderid);
		echo $result;
	}
	...
	function get_produk_list(){
		...
		if($task=='detail')
			$result=$this->m_surat_jalan->get_produk_detail_list($master_id,$query,$start,$end);
		elseif($task=='list')
			$result=$this->m_surat_jalan->get_produk_all_list($query,$start,$end);
		elseif($task=='selected')
			$result=$this->m_surat_jalan->get_produk_selected_list($master_id, $selected_id,$query,$start,$end);
		elseif($task=='order')
			$result=$this->m_surat_jalan->get_produk_order_list($order_id,$query,$start,$end);
		echo $result;
	}
	...
	function get_satuan_list(){
		...
		if($task=='detail')
			$result=$this->m_surat_jalan->get_satuan_detail_list($master_id);
		elseif($task=='produk')
			$result=$this->m_surat_jalan->get_satuan_produk_list($selected_id);
		elseif($task=='selected')
			$result=$this->m_surat_jalan->get_satuan_selected_list($selected_id);
		elseif($task=='order')
			$result=$this->m_surat_jalan->get_satuan_order_list($order_id);
	...
	function get_bonus_list(){
		...
		$selected_id = isset($_POST['selected_id']) ? @$_POST['selected_id'] : @$_GET['selected_id'];
		if($task=='detail')
			$result=$this->m_surat_jalan->get_bonus_detail_list($master_id,$query,$start,$end);
		elseif($task=='list')
			$result=$this->m_surat_jalan->get_produk_all_list($query,$start,$end);
		elseif($task=='selected')
			$result=$this->m_surat_jalan->get_produk_selected_list($master_id,$selected_id,$query,$start,$end);
	...
	function get_faktur_jual_list(){
		$query = isset($_POST['query']) ? @$_POST['query'] : "";
		$start = (integer) (isset($_POST['start']) ? @$_POST['start'] : @$_GET['start']);
		$end = (integer) (isset($_POST['limit']) ? @$_POST['limit'] : @$_GET['limit']);
		
		$result=$this->m_surat_jalan->get_faktur_jual_list($query,$start, $end);
		echo $result;
	}
	
	function get_faktur_jual_search_list(){
		$result=$this->m_surat_jalan->get_faktur_jual_search_list();
		echo $result;
	}
	
	function get_supplier_search_list(){
		$query = isset($_POST['query']) ? $_POST['query'] : "";
		$result=$this->m_surat_jalan->get_supplier_search_list($query);
		echo $result;
	}
	
	function get_terima_gudang_list(){
		$result=$this->m_surat_jalan->get_terima_gudang_list();
		echo $result;
	}
	...
	function get_dorder_satuan_by_produkorder(){
		...
		$result=$this->m_surat_jalan->get_dorder_satuan_by_produkorder($dorder_master, $dorder_produk);
		echo $result;
	}
	...
	function  detail_detail_terima_bonus_list(){
		...
		$end = (integer) (isset($_POST['limit']) ? @$_POST['limit'] : @$_GET['limit']);
		$master_id = (integer) (isset($_POST['master_id']) ? @$_POST['master_id'] : @$_GET['master_id']);
		$result=$this->m_surat_jalan->detail_detail_terima_bonus_list($master_id,$query,$start,$end);
		echo $result;
	}
	//end of handler
	...
	//POST variable here
		...
		$result=$this->m_surat_jalan->detail_detail_terima_bonus_insert($array_dtbonus_id ,$dtbonus_master ,
	...
	//for detail action
	//list detail handler action
	function  detail_detail_surat_jalan_list(){
		$query = isset($_POST['query']) ? @$_POST['query'] : "";
		$start = (integer) (isset($_POST['start']) ? @$_POST['start'] : @$_GET['start']);
		$end = (integer) (isset($_POST['limit']) ? @$_POST['limit'] : @$_GET['limit']);
		$master_id = (integer) (isset($_POST['master_id']) ? @$_POST['master_id'] : @$_GET['master_id']);
		$result=$this->m_surat_jalan->detail_detail_surat_jalan_list($master_id,$query,$start,$end);
		echo $result;
	}
	//end of handler
	...
	function get_master_id(){
		$result=$this->m_surat_jalan->get_master_id();
		echo $result;
	}
	//
	...
	//POST variable here
		...
		$dsurat_jalan_isi_colly = $_POST['dsurat_jalan_isi_colly'];
		$dsurat_jalan_jumlah_colly = $_POST['dsurat_jalan_jumlah_colly'];
		...
		$array_dsurat_jalan_isi_colly = json_decode(stripslashes($dsurat_jalan_isi_colly));
		$array_dsurat_jalan_jumlah_colly = json_decode(stripslashes($dsurat_jalan_jumlah_colly));
		
		$result=$this->m_surat_jalan->detail_detail_terima_beli_insert($array_dterima_id ,$dterima_master ,$array_dterima_produk ,
																			  $array_dterima_satuan , $array_dterima_jumlah, $array_dsurat_jalan_isi_colly, $array_dsurat_jalan_jumlah_colly );
		return $result;
	}
	...
	function get_action(){
		...
		switch($task){
			case "LIST":
				$this->master_surat_jalan_list();
				break;
			case "UPDATE":
				$this->master_surat_jalan_update();
				break;
			case "CREATE":
				$this->master_surat_jalan_create();
				break;
			case "CEK":
				$this->master_surat_jalan_pengecekan();
				break;	
			case "DELETE":
				$this->master_surat_jalan_delete();
				break;
			case "SEARCH":
				$this->master_surat_jalan_search();
				break;
			case "PRINT":
				$this->master_surat_jalan_print();
				break;
			case "EXCEL":
	...
	function check_all_order_done(){
		$master_id = (integer) (isset($_POST['master_id']) ? @$_POST['master_id'] : @$_GET['master_id']);
		$this->m_surat_jalan->check_all_order_done($master_id);
	}
	
	//function fot list record
	function master_surat_jalan_list(){
		
		$query = isset($_POST['query']) ? @$_POST['query'] : "";
		$start = (integer) (isset($_POST['start']) ? @$_POST['start'] :@$_GET['start']);
		$end = (integer) (isset($_POST['limit']) ? @$_POST['limit'] : @$_GET['limit']);
		$result=$this->m_surat_jalan->master_surat_jalan_list($query,$start,$end);
		echo $result;
	}

	function master_surat_jalan_pengecekan(){
	...
	function master_surat_jalan_update(){
		//POST variable here
		$terima_id=trim(@$_POST["surat_jalan_id"]);
		...
		$result = $this->m_surat_jalan->master_surat_jalan_update($terima_id ,$terima_order, $terima_tanggal, $terima_keterangan, $terima_status,$cetak  );
	...
	function master_surat_jalan_create(){
		//POST varible here
		...
		$result=$this->m_surat_jalan->master_surat_jalan_create($terima_no ,$terima_order ,$terima_surat_jalan, $terima_tanggal ,$terima_keterangan, $terima_status, $cetak);
		$this->detail_detail_terima_bonus_insert($result);
		$result=$this->detail_detail_terima_beli_insert($result);
		echo $result;
	}
	...
	function master_surat_jalan_delete(){
		$ids = @$_POST['ids']; // Get our array back and translate it :
		$pkid = json_decode(stripslashes($ids));
		$result=$this->m_surat_jalan->master_surat_jalan_delete($pkid);
		echo $result;
	}

	//function for advanced search
	function master_surat_jalan_search(){
		//POST varibale here
		...
		$start = (integer) (isset($_POST['start']) ? @$_POST['start'] : @$_GET['start']);
		$end = (integer) (isset($_POST['limit']) ? @$_POST['limit'] : @$_GET['limit']);
		$result = $this->m_surat_jalan->master_surat_jalan_search($terima_id ,$terima_no ,$terima_order ,$terima_supplier ,
	...
	function master_surat_jalan_print(){
  		//POST varibale here
		$terima_id=trim(@$_POST["terima_id"]);
		$terima_no=trim(@$_POST["terima_no"]);
		$terima_no=str_replace("/(<\/?)(p)([^>]*>)", "",$terima_no);
		...
		$data["data_print"]  = $this->m_surat_jalan->master_surat_jalan_print($terima_id ,$terima_no ,$terima_order ,$terima_supplier ,
																		$terima_surat_jalan ,$terima_pengirim ,$terima_tgl_awal, 
	...
	function master_terima_beli_export_excel(){
		...
		$query = $this->m_surat_jalan->master_terima_beli_export_excel($terima_id ,$terima_no ,$terima_order ,$terima_supplier ,
																			  $terima_surat_jalan ,$terima_pengirim ,$terima_tgl_awal ,
																			  $terima_tgl_akhir, $terima_keterangan ,$terima_status,$option,$filter,$terima_gudang);
