...
class c_merk extends Controller {
	...
	function get_akun_list(){
		$result=$this->m_merk->get_akun_list();
		echo $result;
	}
	...
	function merk_list(){
		...
		$result=$this->m_merk->merk_list($query,$start,$end);
		echo $result;
	}

	//function for update record
	function merk_update(){
		//POST variable here
		$merk_id=trim(@$_POST["merk_id"]);
		/*
		...
		*/
		$merk_nama=trim(@$_POST["merk_nama"]);
		$merk_nama=str_replace("/(<\/?)(p)([^>]*>)", "",$merk_nama);
		$merk_nama=str_replace("'", '"',$merk_nama);
		//$bank_saldo=trim(@$_POST["bank_saldo"]);
		$merk_keterangan=trim(@$_POST["merk_keterangan"]);
		$merk_keterangan=str_replace("/(<\/?)(p)([^>]*>)", "",$merk_keterangan);
		$merk_keterangan=str_replace("'", '"',$merk_keterangan);
		$merk_aktif=trim(@$_POST["merk_aktif"]);
		$merk_aktif=str_replace("/(<\/?)(p)([^>]*>)", "",$merk_aktif);
		$merk_aktif=str_replace("'", '"',$merk_aktif);
		$result = $this->m_merk->merk_update($merk_id , $merk_nama , $merk_keterangan ,$merk_aktif );
		echo $result;
	}
	...
	function bank_create(){
		...
		*/
		...
		$merk_creator=trim(@$_POST["merk_creator"]);
		$merk_creator=str_replace("/(<\/?)(p)([^>]*>)", "",$merk_creator);
		$merk_creator=str_replace("'", '"',$merk_creator);
		$merk_date_create=trim(@$_POST["merk_date_create"]);
		$merk_update=trim(@$_POST["merk_update"]);
		$merk_update=str_replace("/(<\/?)(p)([^>]*>)", "",$merk_update);
		$merk_update=str_replace("'", '"',$merk_update);
		$merk_date_update=trim(@$_POST["merk_date_update"]);
		$merk_revised=trim(@$_POST["merk_revised"]);
		$result=$this->m_merk->merk_create($merk_nama, $merk_keterangan ,$merk_aktif ,$merk_creator ,$merk_date_create ,$merk_update ,$merk_date_update ,$merk_revised );
		echo $result;
	}
	...
	function bank_delete(){
		...
		$result=$this->m_merk->bank_delete($pkid);
		echo $result;
	}
	...
	function bank_search(){
		...
		$start = (integer) (isset($_POST['start']) ? $_POST['start'] : $_GET['start']);
		$end = (integer) (isset($_POST['limit']) ? $_POST['limit'] : $_GET['limit']);
		$result = $this->m_merk->bank_search($bank_id ,$bank_kode ,$bank_nama ,$bank_norek ,$bank_atasnama ,$bank_saldo ,$bank_keterangan ,$bank_aktif ,$bank_creator ,$bank_date_create ,$bank_update ,$bank_date_update ,$bank_revised ,$start,$end);
		echo $result;
	}
	...
	function bank_print(){
		...
		$result = $this->m_merk->bank_print($bank_id ,$bank_kode ,$bank_nama ,$bank_norek ,$bank_atasnama ,$bank_saldo ,$bank_keterangan ,$bank_aktif ,$bank_creator ,$bank_date_create ,$bank_update ,$bank_date_update ,$bank_revised ,$option,$filter);
	...
	function bank_export_excel(){
		...
		$query = $this->m_merk->bank_export_excel($bank_id ,$bank_kode ,$bank_nama ,$bank_norek ,$bank_atasnama ,$bank_saldo ,$bank_keterangan ,$bank_aktif ,$bank_creator ,$bank_date_create ,$bank_update ,$bank_date_update ,$bank_revised ,$option,$filter);
