...
<table width="1200px" height="110px" border="0" cellspacing="0" cellpadding="0">
  ...
  <td height="50px" width="600px" colspan="2" align="left"><font size=3><b>N O T A  P E N J U A L A N<br><font size=3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$jproduk_nobukti;?></font></td>
  <tr>
...
<table width="1200px" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<td colspan="2"align="right"><b>Jumlah : Rp. &nbsp;<?=rupiah($subtotal);?></td>
	<td></td>
  </tr>
  <tr>
    <? /*<td height="30px" colspan="5"><?=$f_iklantoday_keterangan;?> </td>*/	?>
