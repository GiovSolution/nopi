	...
	detail_order_beli_ColumnModel = new Ext.grid.ColumnModel(
		...
		},
		{
			...
			renderer: function(v, params, record){
				...
				//alert(kurs);
				subtotal=Ext.util.Format.number(((record.data.dorder_harga * kurs) * record.data.dorder_jumlah*(100-record.data.dorder_diskon)/100) + (((record.data.dorder_harga * kurs) * record.data.dorder_jumlah*(100-record.data.dorder_diskon)/100) * (record.data.dorder_komisi)/100) ,"0,000");
...
*/
	...
	function detail_order_beli_total(){
		...
		for(i=0;i<detail_order_beli_DataStore.getCount();i++){
			...
			total_harga_rupiah=total_harga_rupiah+((detail_order_beli_record.data.dorder_jumlah*detail_order_beli_record.data.dorder_harga*(100-detail_order_beli_record.data.dorder_diskon)/100)*order_kurs_nilaiField.getValue()) + (((detail_order_beli_record.data.dorder_harga *order_kurs_nilaiField.getValue()) * detail_order_beli_record.data.dorder_jumlah*(100-detail_order_beli_record.data.dorder_diskon)/100) * (detail_order_beli_record.data.dorder_komisi)/100)  ;
		...
		//alert(order_bekspedisiField.getValue());
		
		//alert(hrgekspedisi_perproduk);
	}
	...
	function detail_order_beli_on_keypress(){
		...
		for(i=0;i<detail_order_beli_DataStore.getCount();i++){
			...
			jumlah_item=jumlah_item+detail_order_beli_record.data.dorder_jumlah;
			total_harga=total_harga+(detail_order_beli_record.data.dorder_jumlah*detail_order_beli_record.data.dorder_harga*(100-detail_order_beli_record.data.dorder_diskon)/100);
			total_harga_rupiah=total_harga_rupiah+((detail_order_beli_record.data.dorder_jumlah*detail_order_beli_record.data.dorder_harga*(100-detail_order_beli_record.data.dorder_diskon)/100)*order_kurs_nilaiField.getValue());
		}
		order_jumlahField.setValue(CurrencyFormatted(jumlah_item));
		order_itemField.setValue(CurrencyFormatted(detail_order_beli_DataStore.getCount()));
